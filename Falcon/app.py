...
from teacher_function import evaluate,extract_text_from_image,extract_text_from_pdf,generate_questions_from_text,generate_student_report,generate_timetable_module
import shutil
...
database=joblib.load('Falcon\database.pkl')
